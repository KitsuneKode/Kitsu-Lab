 ...
 * re-render.
 */
export function usePageArrival(pageIndex: number, instant = false): PageArrival {
  ...
  return {
    ...
    ...(phase === "entering" && !instant ? {} : { "data-mounted": true as const }),
    ...(phase === "instant" || instant ? { "data-instant": true as const } : {}),
  }
}
