  ...
  return (
    <div className="relative flex min-h-dvh w-full flex-col items-center">
      ...
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-6 px-4 pt-24 pb-24 sm:pt-20">
        <div className="mx-auto h-9 w-56 animate-pulse rounded-lg bg-muted/60" />
        <div className="min-h-[min(22rem,68svh)] w-full animate-pulse rounded-xl border bg-card/60 sm:min-h-[min(32rem,74svh)] lg:min-h-[min(40rem,80svh)]" />
        <div className="mx-auto h-10 w-72 animate-pulse rounded-lg bg-muted/50" />
      </div>
    </div>
  )
}
