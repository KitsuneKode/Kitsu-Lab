...
const FILTER_STYLES: Record<
  ArchivalFilterMode,
  (isLeftPage: boolean) => ArchivalStyle
> = {
  aged: (isLeftPage) => ({
    paperBg: 'bg-[#F5EBD7]',
...
function ArchivalCoverPlate({
  plate,
  className,
  style,
  ref,
}: ArchivalCoverPlateProps) {
  return (
    <div
      ref={ref}
      data-density="hard"
        ...
        <div className="my-auto flex flex-col items-center gap-y-3">
          ...
          <div className="my-2 h-24 w-24 text-[#D4AF37] drop-shadow-[0_2px_4px_rgba(0,0,0,0.6)] sm:h-28 sm:w-28">
            <svg
              ...
              fill="none"
              stroke="currentColor"
              className="h-full w-full stroke-[1.4]"
            >
  ...
  return (
    ...
    >
      ...
      >
        <span>
          {isLeftPage
            ? `Page ${plate.pageNumber}`
            : plate.order || 'Plate Specimen'}
        </span>
      ...
      >
        ...
        <div className="mt-3 space-y-1 text-center">
          <h3
            className={`font-serif text-sm font-bold tracking-wide sm:text-base ${theme.headingColor}`}
          >
            {plate.commonName}
          </h3>
      ...
      <div
        className={`border-t pt-2 font-sans text-[10px] leading-relaxed ${theme.ruleBorder} ${theme.subTextColor}`}
      >
...
function ArchivalTextPlate({
  ...
  return (
    ...
    >
      ...
      <div className="my-auto space-y-3">
        {plate.isIndex ? (
          <div className="space-y-4 py-4 text-center">
            <div
              className={`font-sans text-xs tracking-[0.25em] uppercase ${theme.subTextColor}`}
            >
              Archive.org Edition Facsimile
            </div>
            <h2
              className={`font-serif text-xl font-bold ${theme.headingColor}`}
            >
              {plate.commonName}
            </h2>
            <div className={`mx-auto h-px w-12 border-t ${theme.ruleBorder}`} />
            <div
              className={`mx-auto max-w-sm space-y-2 text-left text-xs leading-relaxed ${theme.textColor}`}
            >
          ...
          <>
            ...
            <div className={`border-b pb-2 ${theme.ruleBorder}`}>
              <span
                className={`block font-sans text-[10px] font-semibold tracking-widest uppercase ${theme.accentColor}`}
              >
                {plate.order}
              </span>
              <h2
                className={`font-serif text-lg leading-tight font-bold sm:text-xl ${theme.headingColor}`}
              >
                {plate.commonName}
              </h2>
              <div
                className={`mt-0.5 font-serif text-xs italic ${theme.subTextColor}`}
              >
                {plate.scientificName}
              </div>
            </div>
            ...
            {(plate.length || plate.nestNotes || plate.eggCount) && (
              <div
                className={`space-y-1 rounded border p-2.5 font-sans text-[11px] ${theme.metricSurface}`}
              >
                {plate.length ? (
                  <div>
            ...
            <div
              className={`space-y-2 text-justify text-xs leading-relaxed sm:text-[13px] ${theme.textColor}`}
            >
      ...
      {/* Bottom folio footer */}
      <div
        className={`flex items-center justify-between border-t pt-1.5 font-mono text-[10px] ${theme.ruleBorder} ${theme.subTextColor}`}
      >
...
function ScarletTanagerSvg() {
  return (
    <svg
      viewBox="0 0 320 280"
      className="h-full w-full max-w-[280px] drop-shadow-md"
    >
      <defs>
      ...
      <path
        d="M70,195 C60,175 75,160 90,170 C100,165 110,180 100,195 Z"
        fill="#607038"
        opacity="0.85"
      />
      <path
        d="M220,175 C235,155 255,160 250,180 C265,185 250,200 235,190 Z"
        fill="#506228"
        opacity="0.85"
      />
      ...
      <path
        d="M152,185 L148,206 M148,206 L140,208 M148,206 L155,208"
        stroke="#4A3B32"
        strokeWidth="2.5"
        strokeLinecap="round"
      />
      <path
        d="M168,183 L166,204 M166,204 L160,206 M166,204 L172,206"
        stroke="#4A3B32"
        strokeWidth="2.5"
        strokeLinecap="round"
      />
      ...
      <path d="M125,190 L95,245 L108,248 L135,200 Z" fill="#111" />
...
function EasternBluebirdSvg() {
  return (
    ...
    >
      ...
      <path
        d="M120,240 L120,170 C120,165 140,160 160,160 C180,160 200,165 200,170 L200,240 Z"
        fill="#6B7280"
        opacity="0.7"
        stroke="#4B5563"
        strokeWidth="2"
      ...
      {/* Legs on post */}
      <path
        d="M150,165 L150,175 M150,175 L144,177 M150,175 L156,177"
        stroke="#374151"
        strokeWidth="2.5"
      />
      <path
        d="M165,165 L165,175 M165,175 L159,177 M165,175 L171,177"
        stroke="#374151"
        strokeWidth="2.5"
      />
      ...
      {/* White Belly */}
      <path
        d="M155,152 C162,154 165,162 158,168 C152,166 150,158 155,152 Z"
        fill="#F9FAFB"
      />
...
function SnowyOwlSvg() {
  return (
    ...
    >
      ...
      <path
        d="M40,225 C120,215 200,220 280,230 L275,250 C195,240 115,245 45,255 Z"
        fill="#52525B"
        stroke="#3F3F46"
        strokeWidth="2"
      />
      ...
      <path
        d="M135,130 Q160,135 185,130 M132,145 Q160,150 188,145 M136,160 Q160,165 184,160 M140,175 Q160,180 180,175 M144,190 Q160,195 176,190"
        stroke="#4A3E38"
        strokeWidth="2.5"
        strokeLinecap="round"
        fill="none"
...
function HummingbirdSvg() {
  return (
    ...
    >
      ...
      <path
        d="M50,70 Q100,100 130,135 Q100,140 70,110 Z"
        fill="#EA580C"
        stroke="#C2410C"
        strokeWidth="1.5"
      />
      <path
        d="M30,55 Q50,70 70,80"
        stroke="#65A30D"
        strokeWidth="4"
        strokeLinecap="round"
      />
